...
np.savetxt('v.txt', v_out)

t_steady = 100 *1.3806 * pow(10, -23)/(1.67 * pow(10, -21))
print(pow(10, -21))
...
plt.plot([0.,len(temps)],[t_steady,t_steady],label = 'Target Steady Temperature')
plt.xlabel('Time')
plt.ylabel('Temperature')
plt.savefig('temperature_2.png')
# plt.show()
plt.close()
